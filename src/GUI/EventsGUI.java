...
public class EventsGUI extends JFrame {
        public EventsGUI() {
                ...
                event_poster.setIcon(
                                new ImageIcon((Objects.requireNonNull(getClass().getResource("images/poster.png")))));
                p.add(event_poster);
                ...
                jt.setModel(new DefaultTableModel(new Object[][] { { "EXAM TITLE", "START DATE", "END DATE" },
                                { "Quarterly Exam", "27/08/2021", "02/09/2021" }, { null, null, null },

                }, new String[] { "EXAM TITLE", "START DATE", "END DATE" }));
